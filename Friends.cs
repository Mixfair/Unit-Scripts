...
namespace Oxide.Plugins
{
    ...
    class Friends : CovalencePlugin
    {
        ...
        public class Configuration
        {
            ...
            [JsonProperty("Use permissions system (true/false)")]
        ...
        {
            return GetPlayerData(playerId.ToString()).Friends.ToArray();
        }
        ...
        {
            return GetFriendList(playerId.ToString()).Select(ulong.Parse).ToArray();
        }
