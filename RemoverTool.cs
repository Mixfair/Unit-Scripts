...
namespace Oxide.Plugins
{
    ...
    { 
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string> 
            {
                ["NotAllowed"] = "Тебе не хватает привелегий '{0}' для выполнения этой комманды.",
                ["TargetDisabled"] = "Ремувер {0}'а выключен.",
                ["TargetEnabled"] = "{0} сейчас использует ремувер; Включен на {1} секунд (Макс. удаляемых объектов: {2}, Тип удаления: {3}).",
                ["ToolDisabled"] = "Ремувер выключен.",
                ["ToolEnabled"] = "Ремувер включен на {0} секунд (Макс. удаляемых объектов: {1}, Тип удаления: {2}).",
                ["Cooldown"] = "Подожди {0} секунд перед использованием Ремувера.",
                ["CurrentlyDisabled"] = "Ремувер сейчас недоступен.",
                ["EntityLimit"] = "Достигнут лимит удаления, вы удалили {0} предметов, Ремувер автоматически выключен.",

                ["StartRemoveAll"] = "Начинаем удалять все, подождите.",
                ["StartRemoveStructure"] = "Удаляем структуру, подождите.",
                ["StartRemoveExternal"] = "Start running RemoveExternal, please wait.",
                ["AlreadyRemoveAll"] = "Удаление всего уже запущено, подождите.",
                ["AlreadyRemoveStructure"] = "Удаление структуры уже запущено, подождите.",
                ["AlreadyRemoveExternal"] = "There is already a RemoveExternal running, please wait.",
                ["CompletedRemoveAll"] = "Успешно удалено {0} объектов.",
                ["CompletedRemoveStructure"] = "You'Успешно удалено {0} объектов Структуры.",
                ["CompletedRemoveExternal"] = "You've successfully removed {0} entities using RemoveExternal.",

                ["CanRemove"] = "Ты можешь удалить этот объект.",
                ["NotEnoughCost"] = "Удаление невозможно: Вам не хватает ресурсов.",
                ["EntityDisabled"] = "Удаление невозможно: Server has disabled the entity from being removed.",
                ["DamagedEntity"] = "Удаление невозможно: Server has disabled damaged objects from being removed.",
                ["BeBlocked"] = "Удаление невозможно: An external plugin blocked the usage.",
                ["InvalidEntity"] = "Удаление невозможно: No valid entity targeted.",
                ["NotFoundOrFar"] = "Удаление невозможно: The entity is not found or too far away.",
                ["StorageNotEmpty"] = "Удаление невозможно: The entity storage is not empty.",
                ["RaidBlocked"] = "Удаление невозможно: Raid blocked for {0} seconds.",
                ["NotRemoveAccess"] = "Удаление невозможно: You don't have any rights to remove this.",
                ["NotStructure"] = "Удаление невозможно: The entity is not a structure.",
                ["NotExternalWall"] = "Удаление невозможно: The entity is not an external wall.",
                ["HasStash"] = "Удаление невозможно: There are stashes under the foundation.",
                ["EntityTimeLimit"] = "Удаление невозможно: The entity was built more than {0} seconds ago.",
                ["CantPay"] = "Удаление невозможно: Paying system crashed! Contact an administrator with the time and date to help him understand what happened.",

                ["Refund"] = "Возврат:",
                ["Nothing"] = "Ничего",
                ["Price"] = "Цена:",
                ["Free"] = "Бесплатно",
                ["TimeLeft"] = "Осталось: {0}s\nУдалено: {1}",
                ["RemoverToolType"] = "Remover Tool ({0})",
                ["Unlimit"] = "∞",
